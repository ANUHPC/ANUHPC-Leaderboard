...
export LD_LIBRARY_PATH=$HPL_ROOT/usr/local/cuda/targets/x86_64-linux/lib:$HPL_ROOT/lib/x86_64-linux-gnu:$HPL_ROOT/opt/hpcx/ompi/lib:$HPL_ROOT/opt/hpcx/ucx/lib
...
mpirun -np "${SLURM_NTASKS}" $HPL_ROOT/workspace/hpl-linux-x86_64/hpl.sh --dat "$PWD/HPL.dat"

...
#SBATCH --job-name="mfc-task2-n32-weno5-cfl0025"
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --output="mfc-task2-n32-weno5-cfl0025.out"
#SBATCH --error="mfc-task2-n32-weno5-cfl0025.err"
...
$(printf "$TABLE_FORMAT_LINE" "Job Name"     "mfc-task2-n32-weno5-cfl0025"                        "Engine"     "batch")
...
EOL
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "Finished mfc-task2-n32-weno5-cfl0025:"

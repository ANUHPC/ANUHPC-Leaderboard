...
# --- OpenBLAS threading (8 cores per socket) ---
export OMP_NUM_THREADS=8
export OMP_PROC_BIND=close
export OMP_PLACES=cores
export OPENBLAS_NUM_THREADS=8

# --- MPI transport: TCP over Ethernet (IB not yet configured on compute nodes) ---
...
# Run HPL
mpirun --map-by socket:PE=\${SLURM_CPUS_PER_TASK} \\
  --bind-to core \\
  --report-bindings \\

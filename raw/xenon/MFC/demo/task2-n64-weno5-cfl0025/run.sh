...
#SBATCH --job-name="mfc-task2-n64-weno5-cfl0025"
#SBATCH --nodes=1
#SBATCH --ntasks-per-node=1
#SBATCH --output="mfc-task2-n64-weno5-cfl0025.out"
#SBATCH --error="mfc-task2-n64-weno5-cfl0025.err"
...
$(printf "$TABLE_FORMAT_LINE" "Job Name"     "mfc-task2-n64-weno5-cfl0025"                        "Engine"     "batch")
...
END
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "MFC case # mfc-task2-n64-weno5-cfl0025 @ /scratch/jobs/35234061736/MFC/demo/task2-n64-weno5-cfl0025/case.py:"
    printf "$TABLE_HEADER"
...
. "/scratch/jobs/35234061736/MFC/demo/task2-n64-weno5-cfl0025/mfc-environment.sh" none || exit 1
...
echo
    ...
    cd '/scratch/jobs/35234061736/MFC/demo/task2-n64-weno5-cfl0025'
    ...
    if [ $code -ne 0 ]; then
        ...
        cat >>'/scratch/jobs/35234061736/MFC/demo/task2-n64-weno5-cfl0025/summary.yaml' <<EOL
syscheck:
...
simulation:
    ...
    grind: $(cat '/scratch/jobs/35234061736/MFC/demo/task2-n64-weno5-cfl0025/time_data.dat' | tail -n 1 | awk '{print $NF}')
EOL
    ...
    printf "$TABLE_HEADER"
    printf "$TABLE_TITLE_FORMAT" "Finished mfc-task2-n64-weno5-cfl0025:"
